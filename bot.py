...
async def on_guild_join(guild):
    ...
    For a full list of commands, use `{pfx}help`. Some easter egg commands are not included in the help page. Others like the `jsk` group have been deliberately hidden because they are reserved for the bot owner.
