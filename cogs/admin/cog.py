...
@commands.group(name="utils", aliases=["jsk", "vj"], hidden=JISHAKU_HIDE,
...
async def jsk(self, ctx: commands.Context):
    ...
    summary = [
        f"`Utils v{__version__}, discord.py `{package_version('discord.py')}`, "
    ...
    if sys.version_info < (3, 7, 0):
        ...
        summary.extend([
            "This cog no longer has primary support for Python 3.6. While the cog will still work, some "
...
class Jishaku(JishakuBase, name="VJ Utils", metaclass=GroupCogMeta, command_parent=jsk):
    """
